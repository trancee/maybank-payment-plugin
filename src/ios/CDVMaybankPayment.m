...
- (void)viewDidLoad {
	...
	paymentController = [paymentController initWithDelegate:self UrlEnv:kTestUrlEnv UrlTest:testUrl PayeeCode:@"135" AmountBit:1 Amount:@"900" ReferenceBit:1 ReferenceNo:@"99999999999" AccountBit:1 AccountNo:@"1234567800" URL:@"http://www.gsc.com.my"];
